...
/** Wind-blown variant — same structure, squinting eyes + blowing mouth. */
export function AgentIconWindy({ className }: { className?: string }) {
  return (
    <svg
      viewBox="0 0 64 64"
      fill="none"
    ...
    >
      ...
      {/* Left eye — squinting (flatter arc) */}
      <path d="M21 36 C21 32, 29 32, 29 36" stroke="#2d2d2d" strokeWidth="3.5" strokeLinecap="round" />

      {/* Right eye — squinting (flatter arc) */}
      <path d="M35 36 C35 32, 43 32, 43 36" stroke="#2d2d2d" strokeWidth="3.5" strokeLinecap="round" />

      {/* Mouth — small "o" blowing to the right */}
      <ellipse cx="34" cy="47" rx="3" ry="2.5" stroke="#2d2d2d" strokeWidth="2.5" fill="none" />
    </svg>
  );
}
